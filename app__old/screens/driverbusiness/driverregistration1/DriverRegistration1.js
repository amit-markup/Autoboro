...
class DriverRegistration1 extends React.Component {
  ...
  render() {
    ...
    let date = require("../../../../assets/3.png");
    let upload = require("../../../../assets/2.png");
        ...
        {this.state.loading ?
          ...
          <ScrollView style={{backgroundColor:'#f1f1f1'}}>
            ...
            <TouchableOpacity style={styles.viewLabel4} onPress={this.showDatePicker.bind(this)}>
              ...
              <Image source={date} style={{ width: 30, height: 30, alignSelf: 'center', flex: 0.45, marginRight: 10 }}></Image>
            </TouchableOpacity>
