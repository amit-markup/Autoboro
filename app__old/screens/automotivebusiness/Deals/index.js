    ...
    return (
      <View style={styles.container}>
        <Header style={{backgroundColor:'white'}}>
          ...
          <Body style={{paddingLeft:88}}>
            <Title style={{color:'black'}}>Deals</Title>
          </Body>
        </Header>
        <ScrollView>
        <View style={{marginTop:20, borderRadius:5, padding:10}}>
          <View style={{alignContent:'center', alignItems:'center', alignSelf:'center', justifyContent:'center', borderRadius:10}}>
            <Image source={require('../../../../assets/t16.png')} style={{width:388, height:150, borderRadius:10}}/>
          </View>
        ...
        <FlatList style={styles.list}
          ...
          <TouchableOpacity  onPress={()=> this.createDeals()} style={{position:'absolute', alignSelf:'flex-end', marginTop:560, backgroundColor:'#e8252b', borderRadius:30, padding:10}}>
