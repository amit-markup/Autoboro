...
export default class TimelineScreen extends Component {
  ...
  componentDidMount = async () => {
    ...
    this.setState({ uid: value }, () => this.getMoreData())
      ...
      <Container style={{ backgroundColor: "#e9edf0" }}>
        ...
        <Header style={{ backgroundColor: '#1c4478' }} searchBar rounded noLeft noShadow>
          ...
          <Right style={{ backgroundColor: '#e26d0e', maxWidth: 45, marginLeft: 10, justifyContent: 'center', marginRight: 5 }}>
            ...
            <TouchableWithoutFeedback style={{ backgroundColor: '#e26d0e', margin: 5 }} onPress={() => this.setState({ isFilter: true })}>
              <Icon name="ios-funnel" style={{ fontSize: 25, padding: 6, color: 'white', backgroundColor: '#e26d0e' }} />
        ...
        <Modal transparent={true}
          ...
          <View style={{
            ...
            <TouchableHighlight onPress={() => this.setState({ isFilter: false, }, () => {
              this.getMoreData
              ()
            ...
            renderItem={({ item, index }) => {
              if (item.uids != null) {
                return <View style={{ flex: 1, flexDirection: 'row', backgroundColor: 'white', paddingRight: 10 }}>
                  <Image source={item.CoverPic === null && item.pic !== null ? { uri: "https://www.markupdesigns.org/paypa/" + JSON.parse(item.pic)[0] } : item.pic === null ? require('../../img/common/defaultImg.png') uri: {styles.imageView} />
