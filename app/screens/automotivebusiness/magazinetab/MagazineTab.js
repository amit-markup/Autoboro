...
export default class Posts extends Component {
  ...
  async autogramListing() {
    ...
    await fetch('http://autoboro.markupdesigns.org/api/autogramBusinessListing',
      {
        method: 'POST',
        headers: {
  ...
  async autogramListingDelete(item) {
    ...
    await fetch('http://autoboro.markupdesigns.org/api/deleteAutogram',
      {
        method: 'POST',
        headers: {
          'Apiauthorization': Token,
  ...
  podcastDetail(item) {
    this.props.navigation.navigate("podcastBusinessDetail", { item: item })
  };
  ...
  editAutgram (item) {
    ...
    this.props.navigation.navigate('AutogrambusinessEdit', {item:item})
}

autogramDetails (item) {
  console.log('itemmm', item)
  this.props.navigation.navigate('AutogrambusinessDetail', {item:item})
}
      ...
      <View style={{marginBottom:240}}>
        <Header style={{ backgroundColor: "#E6E6E6", marginLeft: 0 }} searchBar rounded noLeft noShadow>
          ...
          <Right style={{ maxWidth: 85, marginLeft: 4, justifyContent: 'center', marginRight: 2 }}>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate("AutogrambusinessCreate")} style={{ margin: 2 }} >
        ...
        <FlatList style={styles.list}
          ...
          renderItem={(post) => {
            ...
            return (
              <TouchableOpacity style={styles.card} onPress={()=> this.autogramDetails(item)}>
                ...
                <View style={styles.cardFooter}>
                  ...
                  <View style={{ marginLeft: 2, width: "86%" }}>
                    <Text style={{ fontSize: 12 }}>{item.message}</Text>
                  </View>
                  {/* <View style={{ flexDirection: 'row', paddingTop: 2, width: "20%" }}>
                ...
                <View style={{ flexDirection: 'row', marginBottom: 8 }}>
                  <TouchableOpacity onPress={() => this.editAutgram(item)}>
                  ...
                  <TouchableOpacity onPress={() => this.autogramListingDelete(item)}>
    ...
    return (
      <View style={styles.container}>
        <Header style={{ backgroundColor: "#ffffff", marginBottom: 0 }}>
          ...
          <Right>
            <Button transparent>
              <Image source={require('../../../../assets/images/bussiness-setting.png')} style={{ width: 21, height: 21, transform: [{ rotate: '185deg' }] }} />
            </Button>
          </Right>
        </Header>
