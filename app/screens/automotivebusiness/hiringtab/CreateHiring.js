...
export default class EventsView extends Component {
    ...
    async createJob() {
      ...
      await fetch('http://autoboro.markupdesigns.org/api/createJob',
          {
              method: 'POST',
              headers: {
            ...
            <View style={styles.container}>
                <Header style={{ backgroundColor: "#ffffff", marginBottom: 0 }}>
                    ...
                    <Body style={{ paddingLeft: 50 }}>
                        <Title style={{ color: 'black', fontSize: 16 }}>Create Hiring</Title>
                    </Body>
                </Header>

                <ScrollView style={{ backgroundColor: '#f1f1f1' }}>
                    <Item regular style={styles.viewLabel1}>
                    <Input style={styles.input} placeholder='Job Title' onChangeText={(text) => this.setState({ title: text })} />
                    </Item>
                    <Item regular style={styles.viewLabel1}>
                    <Input style={styles.input} placeholder='Job Description' onChangeText={(text) => this.setState({ description: text })} />
                    </Item>
                    ...
                    <Button onPress={()=> this.createJob()} block style={{ width: '90%', marginLeft: '5%', marginRight: '5%', marginTop: 15, backgroundColor: '#f5900e', marginBottom: 10 }}>
